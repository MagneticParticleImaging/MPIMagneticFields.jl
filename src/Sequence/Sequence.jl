...
struct RotationalSequence{RPT} <: MotionPatternSequence where {RPT <: RotationPattern}
  "Total trajectory duration"
  T::typeof(1.0u"s")
  "Rotation pattern of the sequence"
  rotationPattern::RPT
...
struct TranslationalSequence{TPT} <: MotionPatternSequence where {TPT <: TranslationPattern}
  "Total trajectory duration"
  T::typeof(1.0u"s")
  "Translation pattern of the sequence"
...
struct RotationalTranslationalSequence{RPT, TPT} <: MotionPatternSequence where {RPT <: RotationPattern, TPT <: TranslationPattern}
  "Total trajectory duration"
  T::typeof(1.0u"s")
  "Rotation pattern of the sequence"
  rotationPattern::RPT
